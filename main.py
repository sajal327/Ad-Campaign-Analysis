...
# from google.ads.googleads.client import GoogleAdsClient  # Corrected import
# import pandas as pd
# import matplotlib.pyplot as plt
...
#     df.plot(x="Campaign Name", y=["Impressions", "Clicks"], kind="bar", figsize=(10, 6))
#     plt.title("Campaign Performance")
#     plt.xlabel("Campaign Name")
#     plt.ylabel("Metrics")
#     plt.show()
